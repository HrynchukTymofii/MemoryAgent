...
export function Collections({
  ...
  return (
    <div className="panel">
      <h1>Collections</h1>
      <p className="sub">
        Where your memories are filed, and the destinations the router understands — “save
        this to reading” works because a collection called Reading exists. Open one to see
        what is inside it.
      </p>
